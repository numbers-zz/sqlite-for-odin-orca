...
foreign import sqlite "../sqlite_src/sqlite-amalgamation-3480000/sqlite3.o" 
...
foreign sqlite {
	...
	vfs_register::proc(vfs:^Vfs,makeDflt:c.int)->c.int---
	vfs_unregister::proc(vfs:^Vfs)->c.int---
}

STATIC :: uintptr(0)
TRANSIENT :: ~uintptr(0)

AccessFlag::enum c.int{
	EXISTS 		= 0,
	READWRITE 	= 1,
	READ 		= 2,
}
